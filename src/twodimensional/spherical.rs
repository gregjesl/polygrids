...
impl Polyhedron {
    ...
    fn find_root_face(&self, vec: &Vector3<f64>) -> &FaceTree<SharedRayCollection, Ray> {
    ...
    fn find_leaf(&self, ray: &Ray) -> &FaceBranch<SharedRayCollection, Ray> {
    ...
    pub fn find_face(&self, ray: &Ray) -> SharedTriangle<SharedRayCollection> {
